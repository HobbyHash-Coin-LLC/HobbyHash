...
public:
    CachingTransactionSignatureChecker(const CTransaction* txToIn, unsigned int nInIn, const CAmount& amountIn, bool storeIn, SignatureCache& signature_cache, PrecomputedTransactionData& txdataIn, uint32_t replay_fork_id = 0, bool require_fork_sighash = false) : TransactionSignatureChecker(txToIn, nInIn, amountIn, txdataIn, MissingDataBehavior::ASSERT_FAIL, replay_fork_id, require_fork_sighash), store(storeIn), m_signature_cache(signature_cache)  {}
