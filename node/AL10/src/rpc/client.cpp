...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "submitcensus", 1, "pool_id" },
    { "submitcensus", 2, "report" },
    { "getnetworkstats", 0, "nblocks" },
    { "getnetworkstats", 1, "max_samples" },
    { "getrandomxhash", 0, "version" },
    { "getrandomxhash", 3, "time" },
    { "getrandomxhash", 5, "height" },
