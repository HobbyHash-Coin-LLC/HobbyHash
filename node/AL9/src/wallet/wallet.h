...
public:
    ...
    /** Like SignTransaction(tx) but returns a user-visible reason on failure. */
    bool SignTransaction(CMutableTransaction& tx, bilingual_str& fail_reason) const EXCLUSIVE_LOCKS_REQUIRED(cs_wallet);
